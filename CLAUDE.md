...
- **server/** - Express-v5 API with Zod-v4 validation, Postresql databsae using pg to connect
...
Contains Zod schemas and TypeScript types shared between client and server.
